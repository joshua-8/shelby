...
Screen_Home::Screen_Home(generalSetStruct* _genSettings, short* _screenMode, Adafruit_ILI9341* _tft, Screen_Predit* _preditScreen) {
  ...
  musicPlaylistButton = new sButton(tft, MUSIC_PLAYLIST_BUTTON_POS_X, ENTERTAINMENT_BUTTONS_POS_Y, MUSIC_PLAYLIST_BUTTON_WIDTH, ENTERTAINMENT_BUTTONS_HEIGHT, ENTERTAINMENT_BUTTONS_COLOR, ENTERTAINMENT_BUTTONS_ACTIVE_COLOR, ENTERTAINMENT_BUTTONS_TEXT_COLOR, ENTERTAINMENT_BUTTONS_TEXT_COLOR, "playlist: ", true);
